...
<html>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav navbar-sidenav" id="navHide">
        ...
        <li class="nav-item">
          <a class="nav-link sidefrst" href="teacher_dashboard.php">
            <span class="textside"><i class="fa fa-dashcube" aria-hidden="true"></i> Dashboard</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link sidesecnd" href="teacher_course.php">
            <span class="textside"><i class="fa fa-book" aria-hidden="true"></i>  Courses</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link sidesix" href="attendance.php">
