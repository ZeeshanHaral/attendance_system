...
<html>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav navbar-sidenav" id="navHide">
        ...
        <li class="nav-item">
          <a class="nav-link sidefrst" href="{{route('admin_dashboard')}}">
            <span class="textside"><i class="fa fa-dashcube" aria-hidden="true"></i> Dashboard</span>
          </a>
        </li>

        <li class="nav-item">
          <a class="nav-link sidesecnd" href="{{route('admin_addteacher')}}">
            <span class="textside"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Teachers</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link sidesfifth" href="{{route('admin_addstudent')}}">
            <span class="textside"><i class="fa fa-tasks" aria-hidden="true"></i> Add Student</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link sidesthrd" href="{{route('admin_addcourse')}}">
            <span class="textside"><i class="fa fa-book" aria-hidden="true"></i> Add Courses</span>
          </a>
        </li>
        <li class="nav-item">
